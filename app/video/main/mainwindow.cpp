...
const QString VIDEO_SEARCH_PATH_TMP = QStandardPaths::writableLocation(QStandardPaths::HomeLocation).append("/tmp");
...
void MediaUpdateThread::run()
{
    ...
    videoFileList.append(findVideoFiles(VIDEO_SEARCH_PATH_TMP));
