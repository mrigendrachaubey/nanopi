...
v2.0.7.0
  1. cproc: correct cproc xml set error.
  2. adpf: fix the error that can't use the function in utl_fixfloat.cpp.
  3. aec: fix error that the max exp time can't limit by fix fps in IQ xml.
v2.0.8.0
